...
import { AccountNature } from './entities/account-nature.entity';
...
@Module({
  imports: [TypeOrmModule.forFeature([LedgerAccount, LedgerEntry, JournalEntry, AccountNature, AccountGroup])],
